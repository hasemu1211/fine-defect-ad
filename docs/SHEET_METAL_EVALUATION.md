...
| 용어 | 뜻 |
| --- | --- |
| E1 | 전체 이미지를 256×256으로 축소하는 내부 기준선 식별자 |
| legacy E2 | 경계 안정성 검토 후 채택하지 않은 초기 전체 분기 타일링 프로토타입 |
| E2-Split | 국소 타일 맵과 전역 맵을 분리 계산해 결합한 현재 고해상도 추론 경로 |
| TESTpub | MVTec AD 2 공개 시험 분할 114장 |
