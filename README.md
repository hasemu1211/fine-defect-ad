...
동일 체크포인트에서 E2-Split은 E1 256×256 기준선보다 높은 **Image AU-ROC**와 local **AU-PRO@0.05**를 기록했습니다. Image AU-ROC는 이미지별 최종 원시 맵 최대값으로 이상 이미지를 순위화하고, AU-PRO는 픽셀 위치화를 확인합니다. 입력 경로와 평가 산출물을 재현 가능하게 남겨, 재학습 효과와 추론 경로 효과를 분리해 확인할 수 있습니다.
...
| E2-Split TESTpub Image AU-ROC | 0.7347222222222223 | 이미지별 최종 원시 맵 최대값으로 순위화 |
